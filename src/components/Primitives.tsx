  ...
  return (
    <button
      ...
      className={`focus-ring flex items-center gap-2 rounded-lg px-3 py-2 text-[11px] font-mono transition-all duration-300 ${
        pulse ? 'bg-cyan/10 text-cyan/60' : 'text-white/40 hover:bg-white/[0.04] hover:text-white/60'
      }`}
      ...
      >
        <div
          className={`mx-auto max-w-6xl rounded-2xl px-5 py-3 transition-all duration-500 ${
            atTop
              ? 'bg-transparent'
              : 'bg-deep/80 border border-white/[0.05] shadow-[0_1px_0_rgba(0,229,255,0.04)] backdrop-blur-xl'
          }`}
        >
