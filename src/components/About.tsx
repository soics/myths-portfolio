  ...
  return (
    <div ref={ref} className="space-y-2">
      <div className="flex items-center justify-between">
        <span className="text-[10px] font-mono text-blueprint/40 tracking-[0.15em]">PROGRESS TO FULL-STACK</span>
...
export function Manifesto() {
  ...
  return (
    <section ref={sectionRef} id="about" className="px-5 py-24 md:py-32">
      <div className="mx-auto max-w-6xl">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[10px] font-mono uppercase tracking-[0.25em] text-blueprint/40">THE BLUEPRINT</span>
          </div>
        ...
        <div className="grid gap-12 md:gap-14 lg:grid-cols-[1.3fr_0.9fr]">
          <div className="space-y-5">
            ...
            <motion.a
              ...
              className="focus-ring mt-6 inline-flex items-center gap-2 text-sm text-blueprint/50 transition-colors hover:text-blueprint/70 active:scale-[0.97]"
            >
          ...
          >
            ...
            <LiquidGlass variant="panel" tilt={4} className="!rounded-[20px] !p-5">
