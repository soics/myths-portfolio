          ...
          {chapters.map((chapter, i) => {
            ...
            return (
              <motion.article
                ...
                transition={{ delay: i * 0.15, type: 'spring', stiffness: 100, damping: 26 }}
              ...
              >
                ...
                {/* Card */}
                <div className="glass-lift relative overflow-hidden rounded-[18px] transition-all duration-300 hover:shadow-[0_16px_48px_rgba(0,0,0,0.45)]">
                  {/* Background watermark */}
                  <span
                    className="pointer-events-none absolute right-4 top-2 select-none text-[6rem] font-black leading-[0.75] tracking-[-0.08em] text-white/[0.015] md:text-[8rem]"
                    aria-hidden="true"
                  >
                    {chapter.number}
                  </span>
