          ...
          <div className="mt-4 flex items-center gap-3">
            {isLast && (
              <motion.span initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.8 }}
                className="inline-flex items-center gap-1.5 rounded-md border border-construction/15 bg-construction/5 px-2 py-0.5 text-[9px] font-mono text-construction/50">
                <span className="h-1 w-1 rounded-full bg-construction/40 safety-beacon" />
                IN PROGRESS
              </motion.span>
            )}
            <span className="inline-flex items-center gap-1 text-[8px] font-mono text-concrete-mid/20">
              <Stamp size={9} />
              Inspected by myths
            </span>
          </div>
